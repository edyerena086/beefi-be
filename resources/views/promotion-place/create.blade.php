...
{{-- Top button --}}
@section('topButton')
    <a href="{{ url('dashboard/promotion-place')  }}" class="btn btn-primary">Regresar</a>
@endsection

{{-- Main Content --}}
@section('mainContent')
    {{Form::open(['url' => 'dashboard/promotion-place/store', 'files' => true, 'class' => 'form-horizontal form-label-left'])}}
