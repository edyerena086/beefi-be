...
@section('topButton')
    @if($counter < 1)
        <a href="{{ url('dashboard/promotion-place/create')  }}" class="btn btn-primary">Nueva Promoción</a>
    @endif
@endsection
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{url('dashboard/promotion-place/delete/'.base64_encode($promotion->id))}}" class="btn btn-danger btn-delete" data-name="{{$promotion->title}}">Borrar</a>
                </td>
            </tr>
            @endforeach
        </tbody>
